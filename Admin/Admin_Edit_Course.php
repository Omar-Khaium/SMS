    ...
    <table style="margin-top: 5%;width:100%;">
        ...
        if(isset($_REQUEST["error"]))
        {
            switch($_REQUEST["error"])
            {
                ...
                case "Successfull":                    
                    echo '<div align="center">
                        <h6 id="msg" style="color:limegreen;">*Course Updated Successfully</h6>
                    </div>';
                    break;
                case "Failed":                    
                    echo '<div align="center">
                        <h6 id="msg" style="color:orangered;">*Course Updation Failed</h6>
                    </div>';
                    break;
            }
        }
        ...
        echo '</select>
                        ...
                        <tr>
                            <td align="center" onclick="return check()" colspan="3" style="width:100%;"><input type="submit" id="batch_submit" name="batch_submit" class="w3-input w3-border w3-round w3-blue" style="width:100%;" value="Update">
                            </td>
                        </tr>';
        }
            echo '
