...
<body>
    ...
    <table style="margin:0 auto;margin-top: 5%;width:80%;">
        <form action="edit_tcr.php" method="post" enctype="multipart/form-data">
        ...
        if(isset($_SESSION["tcr_id"]))
        {
            echo'
                        ...
                        <tr>
                            ...
                            <td style="width:40%;">
                                <input name="tcr_id" id="tcr_id" class="w3-input w3-border w3-round" type="text" value='.$resultTCR[0]["Id"].' readonly>
                            </td>
                            <td rowspan="3" style="padding-left:50px;">
                                <div class="w3-card-1">
                                    <img src='.$resultTCR[0]["Photo"].' alt="Profile Picture" style="width:100px;height:100px;" id="profile_picture" name="profile_picture"><br>
                        ...
                        <tr>
                            ...
                            <td style="width:100%;">
                                <input value='.$resultTCR[0]["Name"].' name="tcr_name" id="tcr_name" class="w3-input w3-border w3-round" type="text">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width:100%;">
                                <input value='.$resultTCR[0]["Email"].' name="tcr_email" id="tcr_email" class="w3-input w3-border w3-round" type="email">
                            </td>
                        </tr>
                        <tr>
                            <td style="width:20%;">
                            ...
                            <td style="width:25%">
                                <input value='.$resultTCR[0]["Mobile"].' name="tcr_mobile" id="tcr_mobile" class="w3-input w3-border w3-round" type="text">
                            </td>
							 <td style="padding-left:50px;"><input type="submit" onclick="return check()" class="w3-button w3-blue w3-border w3-round" style="width: 100px;" name="submit" value="Update"></td>
                        </tr>
                            ...
                            <td style="width:25%;">
                                ...
                                switch($resultTCR[0]["Department"])
                                {
                                    ...
                                    case 3:                                        
                                        echo '<option value="1">Bangla</option>
                                        <option value="2">English</option>
                                        <option value="3" selected>Mathmatics</option>
                                        <option value="4">Science</option>
                                        <option value="5">Commerce</option>
                                        <option value="6">Arts</option>';
                                        break;
                        ...
                        <tr>
                            ...
                            <td style="width:25%">
                                <input value='.$resultTCR[0]["Salary"].' name="tcr_salary" id="tcr_salary" class="w3-input w3-border w3-round" type="number">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width:25%;">
                                <input value='.$resultTCR[0]["DOB"].' type="date" class="w3-input w3-border w3-round" name="tcr_dob" id="tcr_dob">
                            </td>
                        </tr>
                        <tr>
                            <td style="width:20%;">
                        ...
                        <tr>
                            ...
                            {
                                echo '<input class="w3-radio" type="radio" name="tcr_gender" id="male" value="male" checked>
                                <label>Male</label>

                                <input class="w3-radio" type="radio" name="tcr_gender" id="female" value="female">
                                <label>Female</label>';
                            }
                            else if($resultTCR[0]["Gender"]=="female")
                            {
                                echo '<input class="w3-radio" type="radio" name="tcr_gender" id="male" value="male">
                                <label>Male</label>

                                <input class="w3-radio" type="radio" name="tcr_gender" id="female" value="female" checked>
                                <label>Female</label>';
                            }
                                    echo '
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width:25%">
                                <input value='.$resultTCR[0]["Current Balance"].' name="tcr_ballance" id="tcr_ballance" class="w3-input w3-border w3-round" type="text">
                            </td>
                        </tr>
                        <tr>
                            <td style="width:20%;">
                            ...
                            <td style="width:25%">
                                <input value='.$resultTCR[0]["Address"].' name="tcr_address" id="tcr_address" class="w3-input w3-border w3-round" type="text">';
        ...
        else
        {
            echo'
                        ...
                        <tr>
                            ...
                            <td rowspan="3" style="padding-left:50px;">
                                <div class="w3-card-1">
                                    <img src="../images/img_avatar3.png" alt="Profile Picture" style="width:100px;height:100px;" id="profile_picture" name="profile_picture"><br>
                                    <input type="file" style="width:100px;" name="photoUpload" id="photoUpload">
