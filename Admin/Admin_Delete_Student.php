...
<body>
    ...
    <table style="margin: 0 auto;margin-top: 5%;width:80%;">
                    ...
                    switch($_REQUEST["error"])
                    {
                        case "Successfull":                    
                            echo '<div align="center">
                                <h6 id="msg" style="color:limegreen;">*Student Deleted Successfully</h6>
                            </div>';
                            break;
                        case "Failed":                    
                            echo '<div align="center">
                                <h6 id="msg" style="color:orangered;">*Student Deletion Failed</h6>
                            </div>';
                            break;
                    }
                }
        ...
        {
            echo '
                                <input class="w3-input w3-border w3-round" type="text" name="student_name" id="STD_Name" value='.$resultSTD[0]["Std_Name"].' readonly>';
        }
        else
        {
            echo'   <input class="w3-input w3-border w3-round" type="text" name="student_name" id="STD_Name" readonly>';
        }
            echo '
                            </td>
                        </tr>
        ...
        {
            echo '
                                <input class="w3-input w3-border w3-round" type="text" name="student_father_name" id="STD_Father" value='.$resultSTD[0]["Std_Father_Name"].' readonly>';
        }
        else
        {
            echo'   <input class="w3-input w3-border w3-round" type="text" name="student_father_name" id="STD_Father" readonly>';
        }
            echo '
                            </td>
                        </tr>
        ...
        {
            echo '
                                <input class="w3-input w3-border w3-round" type="text" name="student_mother_name" id="STD_Mother" value='.$resultSTD[0]["Std_Mother_Name"].' readonly>';
        }
        else
        {
            echo'<input class="w3-input w3-border w3-round" type="text" name="student_mother_name" id="STD_Mother" readonly>';
        }
            echo '
                            </td>
                            <td><input type="submit" onclick="return check()" class="w3-button w3-red" style="width: 100px;" name="submit" value="Delete">
                        </tr>
                        <tr>
                            <td style="width:15%;">
                                Email
        ...
        {
            echo '
                                <input class="w3-input w3-border w3-round" type="email" name="student_email" id="STD_Email" value='.$resultSTD[0]["Email"].' readonly>';
        }
        else
        {
            echo'
            <input class="w3-input w3-border w3-round" type="email" name="student_email" id="STD_Email" readonly>';
        }
            echo '
                            </td>
                        </tr>
        ...
        {
            echo '
                                <input class="w3-input w3-border w3-round" type="number" name="student_roll" id="STD_Roll" value='.$resultSTD[0]["Roll"].' readonly>';
        }
        else
        {
            echo'<input class="w3-input w3-border w3-round" type="number" name="student_roll" id="STD_Roll" readonly>';
        }
            echo '
                            </td>
                        </tr>
        ...
        {
            echo '
                                <select onchange="getData()" class="w3-select w3-border w3-round"  name="student_class"  id="STD_Class" readonly>
        ...
        {
        echo'                   <select onchange="getData()" class="w3-select w3-border w3-round"  name="student_class"  id="STD_Class" readonly>
                                    <option value="0" disabled selected>Choose a class</option>
            ...
            echo '
                        ...
                        <tr>
                            ...
                            <td style="width:40%;">
                                <select class="w3-select w3-border w3-round" id="STD_Batch" name="student_batch" readonly>'; 
        echo '<option value="0" disabled selected>Choose a Batch</option>'; 
                            if(isset($_SESSION["std_id"]))
                            {   
                                foreach($resultBatch as $data)
                        ...
                        <tr>
                            ...
                            {
                                echo '
                                <input name="student_dob" id="STD_DOB" class="w3-input w3-border w3-round" type="date" max="01-01-2012" value='.$resultSTD[0]["DOB"].' readonly>';
                            }
                            else
                            {
                                echo'<input name="student_dob" id="STD_DOB" class="w3-input w3-border w3-round" type="date" max="01-01-2012" readonly>';
                            }
                            echo '
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:40%;">
                                <select class="w3-select w3-border w3-round" id="STD_BG" name="blood_group" readonly>
                        ...
                        <tr>
                            ...
                            if(isset($_SESSION["std_id"]))
                            {
                                ...
                                {
                                    echo '<input class="w3-radio" type="radio" name="STD_Gender" id="male" value="male" checked readonly>
                                    <label>Male</label>

                                    <input class="w3-radio" type="radio" name="STD_Gender" id="female" value="female" readonly>
                                    <label>Female</label>';
                                }
                                else if($resultSTD[0]["Gender"]=="female")
                                {
                                    
                                    echo '<input class="w3-radio" type="radio" name="STD_Gender" id="male" value="male" readonly>
                                    <label>Male</label>

                                    <input class="w3-radio" type="radio" name="STD_Gender" id="female" value="female" checked readonly>
                                    <label>Female</label>';
                                }
                            }
                            else
                            {
                                echo '
                                <input class="w3-radio" type="radio" name="STD_Gender" id="male" value="male" checked readonly>
                                <label>Male</label>
                        ...
                        <tr>
                            ...
                            <td style="width:40%;">
                                <select class="w3-select w3-border w3-round" id="STD_Religion" name="religion" readonly>
                        ...
                        <tr>
                            ...
                            {
                                echo '
                                <input class="w3-input w3-border w3-round" type="number" id="STD_Ballance" name="student_ballance" value='.$resultSTD[0]["Current Balance"].'> readonly';
                            }
                            else
                            {
                                echo '<input class="w3-input w3-border w3-round" type="number" id="STD_Ballance" name="student_ballance" readonly readonly>';
                            }
                            echo '
                            </td>
                        </tr>
                        <tr>
                            ...
                            {
                                echo '
                                <input class="w3-input w3-border w3-round" type="text" name="student_address" id="STD_Address" value='.$resultSTD[0]["Address"].' readonly>';
                                unset($_SESSION['std_id']);
                            }
                            else
                            {
                                echo '<input class="w3-input w3-border w3-round" type="text" name="student_address" id="STD_Address" readonly>';
                            }
                            echo '
                            </td>
                        </tr>
    ...
    <script>
        function check()
        {
            ...
            if(id == 0)
            {
                document.getElementById("msg").innerHTML = "*Choose a student to perform Delete operation";
