        ...
        <ul class="w3-ul w3-card-4">
            <li class="w3-bar">
                <div class="w3-bar-item">
                    <div class="w3-container">
                        <a href="#" onclick="document.getElementById(\'id01\').style.display=\'block\'" class="w3-text">Irregular</a>
            ...
            <li class="w3-bar">
                <div class="w3-bar-item">
                    <div class="w3-container">
                        <a href="#" onclick="document.getElementById(\'id01\').style.display=\'block\'" class="w3-text">Manner Problem</a>
                    ...
                    <span>Bangla-2nd Paper</span>
                </div>
            </li>
            <li class="w3-bar">
                <div class="w3-bar-item">
                    <div class="w3-container">
                        <a href="#" onclick="document.getElementById(\'id01\').style.display=\'block\'" class="w3-text">Class Late</a>
