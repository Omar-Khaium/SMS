...
<body>
                    ...
                    switch($_REQUEST["info"])
                    {
                        case 1:                    
                            echo '<div align="center">
                                <h6 id="msg" style="color:green;">*Complain posted successfully</h6>
                            </div>';
                            break;
                        case 2:                    
                            echo '<div align="center">
                                <h6 id="msg" style="color:orangered;">*Complain posting failed</h6>
                            </div>';
                            break;
                    }
                }
            ...
            <tr>
                ...
                <td class="w3-cell-top" style="padding-left:150px;width:100%">
                    ...
                    <div class="w3-container w3-border w3-padding-16">
                        ...
                        <form action="submitComplain.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">

                            <div class="w3-row w3-section">
                                <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
                                <div class="w3-rest">
                                    <input class="w3-input w3-border" id="student_id" name="student_id" type="text" placeholder="Student ID">
                                </div>
                            </div>
                            ...
                            <div class="w3-row w3-section">
                                ...
                                <div class="w3-rest">
                                    <input class="w3-input w3-border" id="subject" name="subject" type="text" placeholder="Subject">
                                </div>
                            </div>
                            ...
                            <div class="w3-row w3-section">
                                ...
                                <div class="w3-rest">
                                    <input class="w3-input w3-border" id="message" name="message" type="text" placeholder="Description">
                                </div>
                            </div>

                            <input type="submit" onclick="return check()" class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding" value="Submit Complain">
    ...
    <script>
        ...
        function check() {
            ...
            var sub = document.getElementById("subject").value.length;
            var desc = document.getElementById("message").value.length;
            if(id > 0 && desc > 0 && sub > 0)
            {
                return true;
            }
            else
