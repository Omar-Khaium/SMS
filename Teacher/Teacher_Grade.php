...
<form action="gradeSubmit.php" method="post">
                    ...
                    switch($_REQUEST["info"])
                    {
                        case 1:                    
                            echo '<div align="center">
                                <h6 id="msg" style="color:green;">*Grade uploaded successfully</h6>
                            </div>';
                            break;
                        case 2:                    
                            echo '<div align="center">
                                <h6 id="msg" style="color:orangered;">*Grade upload failed</h6>
                            </div>';
                            break;
                    }
                }
    ...
    <script>
        ...
        {
            var ClassValue = element.value;
            window.location = "Teacher_Grade_Batch.php?Batch="+ClassValue;
        }
